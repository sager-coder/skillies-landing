...
/**
 * WorkshopTalkFirst — "Not ready to pay yet?" lead-capture section.
 *
 * Kerala buyers overwhelmingly prefer a WhatsApp conversation before
 * clicking a payment link. Without this section, anyone who's not ready
 * to checkout drops off — with it, they hit WhatsApp, Ehsan (or the sales
 * lead) qualifies them, and they come back to Razorpay when warm.
 *
 * The `id="talk"` anchor is what the WorkshopTopBar "Talk first" link
 * scrolls to, and what the WhatsApp lead capture flow from Meta ads can
 * point at via `skillies.ai/workshop#talk`.
 */
export function WorkshopTalkFirst() {
  const msg = encodeURIComponent(
    "Hi Ehsan, I'm interested in the Kerala Tour workshop. My name is ",
  );
  const href = `https://wa.me/918714318352?text=${msg}`;
  ...
  return (
    ...
    >
      {/* Soft gold radial — mirrors the hero aesthetic */}
      <div
        aria-hidden
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 10% 30%, rgba(230,193,120,0.18), transparent 55%), radial-gradient(ellipse at 90% 80%, rgba(198,40,40,0.14), transparent 55%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ position: "relative", maxWidth: 960, margin: "0 auto" }}>
        ...
        >
          Kerala's preferred channel — a real conversation, not a form queue.
          Ask me which city fits your schedule, what we cover, whether your
          niche is a fit. I reply personally, usually within a few hours.
        </p>
        ...
        >
          <a
            ...
            style={{
              ...
              borderRadius: 999,
              textDecoration: "none",
              boxShadow: "0 20px 44px rgba(37,211,102,0.28)",
            }}
          >
          ...
          >
            Personal line · not a chatbot.
          </span>
        </div>

        {/* Three reasons to talk before buying */}
        <div
          style={{
            display: "grid",
            gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))",
        ...
        >
          {[
            {
              h: "Pick the right city",
              b: "Malappuram · Calicut · Kochi. I'll help you choose based on your distance and schedule.",
            },
            {
              h: "Check niche fit",
              b: "Tell me your background — teacher, designer, writer. I'll tell you honestly if this is for you.",
            },
            {
              h: "Ask anything",
              b: "About Amazon KDP, AI tools, income realities. Straight answers, no sales script.",
            },
          ].map((card, i) => (
            <div
              key={i}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 28, fontSize: 13, color: "#6B7280", fontWeight: 500 }}>
        ...
        <a href="#talk" style={{ color: "inherit", textDecoration: "none" }}>Talk first</a>
