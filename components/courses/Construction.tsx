          ...
          >
            ...
            <div
              ...
              style={{
                ...
                inset: 0,
                background:
                  "radial-gradient(ellipse at 90% 50%, rgba(201,162,78,0.25), transparent 60%)",
                pointerEvents: "none",
              }}
            />
            <div
            ...
            >
              <div>
                ...
                >
                  Founding-batch members get first access + launch pricing.
                  Everyone else: drop a WhatsApp — I message you when the next
                  module is ready, no list, no spam, no automation.
                </p>
              </div>
              <a
                href="https://wa.me/918089941131?text=Hi%20Ehsan%2C%20notify%20me%20when%20the%20next%20Skillies.AI%20course%20drops."
                target="_blank"
                ...
                style={{
                  ...
                  textDecoration: "none",
                  whiteSpace: "nowrap",
                  boxShadow: "0 20px 40px rgba(198,40,40,0.25)",
                }}
              >
